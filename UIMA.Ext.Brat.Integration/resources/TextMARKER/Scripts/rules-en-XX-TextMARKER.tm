...
// second of January
TE_PossibleDayNumber "of" TE_Month{->MARKONCE(TE,1,2,3)};
// May-99
TE_Month "-" NUM{REGEXP("[0-9]{2}")->MARKONCE(TE,1,2,3)};
//10-Feb
TE_PossibleDayNumber "-" TE_Month{->MARKONCE(TE,1,2,3)};
// June 1995
TE_Month TE_PossibleYear{->MARKONCE(TE,1,2)};
// 14-Feb-99
TE_PossibleDayNumber "-" TE_Month "-" NUM{REGEXP("^([0-9]{2})$")->MARKONCE(TE,1,2,3,4,5)};
// 20/06/87
TE_PossibleDayNumber "/" TE_PossibleDayNumber "/" NUM{REGEXP("^(1[6-9]|2[0-2])?[0-9]{2}$")->MARKONCE(TE,1,2,3,4,5)};
// 12.4.2009
TE_PossibleDayNumber "." TE_PossibleDayNumber "." NUM{REGEXP("^(1[6-9]|2[0-2])?[0-9]{2}$")->MARKONCE(TE,1,2,3,4,5)};
// 19-10-2005
TE_PossibleDayNumber "-" TE_PossibleDayNumber "-" NUM{REGEXP("^(1[6-9]|2[0-2])?[0-9]{2}$")->MARKONCE(TE,1,2,3,4,5)};
// 2010-10-19
NUM{REGEXP("^(1[6-9]|2[0-2])?[0-9]{2}$")} "-" TE_PossibleDayNumber "-" TE_PossibleDayNumber{->MARKONCE(TE,1,2,3,4,5)};
// December 30th, 2010
TE COMMA TE_PossibleYear{->MARKONCE(TE,1,2,3)};
// Monday, June 5th, 2011
TE_Day COMMA TE{->MARKONCE(TE,1,2,3,4)};
...
//
HL_Acquisition{->GETFEATURE("slot1",slot1), GETFEATURE("slot2",slot2)} "for" HL_PriceUnit{->CREATE(HL_Acquisition, 1, 2, 3, "slot1"=slot1, "slot2"=slot2)};
...
HL_Person HL_PositionChangeIndicator W*? HL_Position "of" "the"? HL_Company TE?{-> GATHER(HL_PositionChange,1,2,3,4,5,7,8,"person" = 1, "newPosition" = 4, "newCompany" = 7)};
//
