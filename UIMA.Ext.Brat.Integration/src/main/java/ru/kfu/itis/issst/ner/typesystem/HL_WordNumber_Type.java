...
public class HL_WordNumber_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("ru.kfu.itis.issst.ner.typesystem.HL_WordNumber");
  ...
  public String getNum(int addr) {
      ...
      jcas.throwFeatMissing("num", "ru.kfu.itis.issst.ner.typesystem.HL_WordNumber");
