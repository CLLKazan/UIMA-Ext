...
public class HL_Acquisition_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("ru.kfu.itis.issst.ner.typesystem.HL_Acquisition");
  ...
  public int getSlot1(int addr) {
      ...
      jcas.throwFeatMissing("slot1", "ru.kfu.itis.issst.ner.typesystem.HL_Acquisition");
  ...
  public int getSlot2(int addr) {
      ...
      jcas.throwFeatMissing("slot2", "ru.kfu.itis.issst.ner.typesystem.HL_Acquisition");
  ...
  public HL_Acquisition_Type(JCas jcas, Type casType) {
    ...
    casFeat_slot1 = jcas.getRequiredFeatureDE(casType, "slot1", "ru.kfu.itis.issst.ner.typesystem.Annotation", featOkTst);
    casFeatCode_slot1  = (null == casFeat_slot1) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_slot1).getCode();

 
    casFeat_slot2 = jcas.getRequiredFeatureDE(casType, "slot2", "ru.kfu.itis.issst.ner.typesystem.Annotation", featOkTst);
