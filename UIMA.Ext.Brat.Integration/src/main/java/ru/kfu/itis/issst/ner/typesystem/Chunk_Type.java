...
public class Chunk_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("ru.kfu.itis.issst.ner.typesystem.Chunk");
  ...
  public String getChunkType(int addr) {
      ...
      jcas.throwFeatMissing("chunkType", "ru.kfu.itis.issst.ner.typesystem.Chunk");
