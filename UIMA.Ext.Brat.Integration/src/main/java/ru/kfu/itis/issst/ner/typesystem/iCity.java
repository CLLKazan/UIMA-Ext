 ...
 * @generated */
public class iCity extends Annotation {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(iCity.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected iCity() {/* intentionally empty block */}
    
  /** Internal - constructor used by generator 
   * @generated */
  public iCity(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public iCity(JCas jcas) {
    super(jcas);
    readObject();   
  } 

  /** @generated */  
  public iCity(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
