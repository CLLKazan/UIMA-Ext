...
public class HL_AnnouncementIndicator_Type extends EventIndicator_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("ru.kfu.itis.issst.ner.typesystem.HL_AnnouncementIndicator");
  ...
  public int getDate(int addr) {
      ...
      jcas.throwFeatMissing("date", "ru.kfu.itis.issst.ner.typesystem.HL_AnnouncementIndicator");
