...
public class Token_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("ru.kfu.itis.issst.ner.typesystem.Token");
  ...
  public String getPosTag(int addr) {
      ...
      jcas.throwFeatMissing("posTag", "ru.kfu.itis.issst.ner.typesystem.Token");
  ...
  public String getSemClass(int addr) {
      ...
      jcas.throwFeatMissing("SemClass", "ru.kfu.itis.issst.ner.typesystem.Token");
  ...
  public String getPOS(int addr) {
      ...
      jcas.throwFeatMissing("POS", "ru.kfu.itis.issst.ner.typesystem.Token");
  ...
  public int getFrost_TokenType(int addr) {
      ...
      jcas.throwFeatMissing("frost_TokenType", "ru.kfu.itis.issst.ner.typesystem.Token");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("text", "ru.kfu.itis.issst.ner.typesystem.Token");
  ...
  public String getStemForm(int addr) {
      ...
      jcas.throwFeatMissing("stemForm", "ru.kfu.itis.issst.ner.typesystem.Token");
