...
public class DocumentMetadata_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.hp.hpl.typesystem.DocumentMetadata");
  ...
  public String getUri(int addr) {
      ...
      jcas.throwFeatMissing("uri", "com.hp.hpl.typesystem.DocumentMetadata");
  ...
  public int getOffset(int addr) {
      ...
      jcas.throwFeatMissing("offset", "com.hp.hpl.typesystem.DocumentMetadata");
  ...
  public int getDocumentSize(int addr) {
      ...
      jcas.throwFeatMissing("documentSize", "com.hp.hpl.typesystem.DocumentMetadata");
  ...
  public boolean getLastSegment(int addr) {
      ...
      jcas.throwFeatMissing("lastSegment", "com.hp.hpl.typesystem.DocumentMetadata");
  ...
  public String getTitle(int addr) {
      ...
      jcas.throwFeatMissing("title", "com.hp.hpl.typesystem.DocumentMetadata");
  ...
  public String getEncoding(int addr) {
      ...
      jcas.throwFeatMissing("encoding", "com.hp.hpl.typesystem.DocumentMetadata");
  ...
  public long getStartProcessingTicks(int addr) {
      ...
      jcas.throwFeatMissing("startProcessingTicks", "com.hp.hpl.typesystem.DocumentMetadata");
  ...
  public long getStopProcessingTicks(int addr) {
      ...
      jcas.throwFeatMissing("stopProcessingTicks", "com.hp.hpl.typesystem.DocumentMetadata");
  ...
  public int getTags(int addr) {
      ...
      jcas.throwFeatMissing("tags", "com.hp.hpl.typesystem.DocumentMetadata");
  ...
  public int getClasses(int addr) {
      ...
      jcas.throwFeatMissing("classes", "com.hp.hpl.typesystem.DocumentMetadata");
