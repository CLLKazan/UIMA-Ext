...
public class EmailAddress_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.hp.hplabs.lim2.ie.text.typesystem.EmailAddress");
  ...
  public String getLocalPart(int addr) {
      ...
      jcas.throwFeatMissing("localPart", "com.hp.hplabs.lim2.ie.text.typesystem.EmailAddress");
  ...
  public String getDomainPart(int addr) {
      ...
      jcas.throwFeatMissing("domainPart", "com.hp.hplabs.lim2.ie.text.typesystem.EmailAddress");
  ...
  public String getNormalizedEmail(int addr) {
      ...
      jcas.throwFeatMissing("normalizedEmail", "com.hp.hplabs.lim2.ie.text.typesystem.EmailAddress");
