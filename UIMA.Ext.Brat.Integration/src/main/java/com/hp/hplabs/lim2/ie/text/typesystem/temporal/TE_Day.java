 ...
 * @generated */
public class TE_Day extends TE_Base {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(TE_Day.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected TE_Day() {/* intentionally empty block */}
    
  /** Internal - constructor used by generator 
   * @generated */
  public TE_Day(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public TE_Day(JCas jcas) {
    super(jcas);
    readObject();   
  } 

  /** @generated */  
  public TE_Day(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
