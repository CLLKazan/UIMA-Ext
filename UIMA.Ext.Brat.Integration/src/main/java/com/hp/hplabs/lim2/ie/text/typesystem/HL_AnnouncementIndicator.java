...
import com.hp.hplabs.lim2.ie.text.typesystem.temporal.TE;
...
public class HL_AnnouncementIndicator extends EventIndicator {
  ...
  public TE getDate() {
    if (HL_AnnouncementIndicator_Type.featOkTst && ((HL_AnnouncementIndicator_Type)jcasType).casFeat_date == null)
      jcasType.jcas.throwFeatMissing("date", "com.hp.hplabs.lim2.ie.text.typesystem.HL_AnnouncementIndicator");
