...
public class HL_CompanyAnnouncement_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.hp.hplabs.lim2.ie.text.typesystem.HL_CompanyAnnouncement");
  ...
  public int getCompany(int addr) {
      ...
      jcas.throwFeatMissing("company", "com.hp.hplabs.lim2.ie.text.typesystem.HL_CompanyAnnouncement");
