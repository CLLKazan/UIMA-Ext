...
public class Annotation_Type extends org.apache.uima.jcas.tcas.Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.hp.hplabs.lim2.ie.text.typesystem.Annotation");
  ...
  public String getAnnotatorID(int addr) {
      ...
      jcas.throwFeatMissing("annotatorID", "com.hp.hplabs.lim2.ie.text.typesystem.Annotation");
  ...
  public double getConfidence(int addr) {
      ...
      jcas.throwFeatMissing("confidence", "com.hp.hplabs.lim2.ie.text.typesystem.Annotation");
