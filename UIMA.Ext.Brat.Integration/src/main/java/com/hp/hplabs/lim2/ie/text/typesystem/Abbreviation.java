...
public class Abbreviation extends Annotation {
  ...
  /** getter for expan - gets The full form of an abbreviation. For example he fullform, for example for HLA (human leukocyte antigen)
   * @generated */
  public String getExpan() {
    if (Abbreviation_Type.featOkTst && ((Abbreviation_Type)jcasType).casFeat_expan == null)
      jcasType.jcas.throwFeatMissing("expan", "com.hp.hplabs.lim2.ie.text.typesystem.Abbreviation");
    return jcasType.ll_cas.ll_getStringValue(addr, ((Abbreviation_Type)jcasType).casFeatCode_expan);}
    
  /** setter for expan - sets The full form of an abbreviation. For example he fullform, for example for HLA (human leukocyte antigen) 
   * @generated */
  ...
  public Annotation getTextReference() {
    if (Abbreviation_Type.featOkTst && ((Abbreviation_Type)jcasType).casFeat_textReference == null)
      jcasType.jcas.throwFeatMissing("textReference", "com.hp.hplabs.lim2.ie.text.typesystem.Abbreviation");
  ...
  public boolean getDefinedHere() {
    if (Abbreviation_Type.featOkTst && ((Abbreviation_Type)jcasType).casFeat_definedHere == null)
      jcasType.jcas.throwFeatMissing("definedHere", "com.hp.hplabs.lim2.ie.text.typesystem.Abbreviation");
