...
public class Abbreviation_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.hp.hplabs.lim2.ie.text.typesystem.Abbreviation");
  ...
  public String getExpan(int addr) {
      ...
      jcas.throwFeatMissing("expan", "com.hp.hplabs.lim2.ie.text.typesystem.Abbreviation");
  ...
  public int getTextReference(int addr) {
      ...
      jcas.throwFeatMissing("textReference", "com.hp.hplabs.lim2.ie.text.typesystem.Abbreviation");
  ...
  public boolean getDefinedHere(int addr) {
      ...
      jcas.throwFeatMissing("definedHere", "com.hp.hplabs.lim2.ie.text.typesystem.Abbreviation");
  ...
  public Abbreviation_Type(JCas jcas, Type casType) {
    ...
    casFeat_textReference = jcas.getRequiredFeatureDE(casType, "textReference", "com.hp.hplabs.lim2.ie.text.typesystem.Annotation", featOkTst);
