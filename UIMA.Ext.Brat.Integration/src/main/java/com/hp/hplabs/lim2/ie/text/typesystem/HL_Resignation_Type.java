...
public class HL_Resignation_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.hp.hplabs.lim2.ie.text.typesystem.HL_Resignation");
  ...
  public int getPerson(int addr) {
      ...
      jcas.throwFeatMissing("person", "com.hp.hplabs.lim2.ie.text.typesystem.HL_Resignation");
  ...
  public int getPosition(int addr) {
      ...
      jcas.throwFeatMissing("position", "com.hp.hplabs.lim2.ie.text.typesystem.HL_Resignation");
  ...
  public int getCompany(int addr) {
      ...
      jcas.throwFeatMissing("company", "com.hp.hplabs.lim2.ie.text.typesystem.HL_Resignation");
  ...
  public int getApprovedBy(int addr) {
      ...
      jcas.throwFeatMissing("approvedBy", "com.hp.hplabs.lim2.ie.text.typesystem.HL_Resignation");
  ...
  public HL_Resignation_Type(JCas jcas, Type casType) {
    ...
    casFeat_position = jcas.getRequiredFeatureDE(casType, "position", "com.hp.hplabs.lim2.ie.text.typesystem.Annotation", featOkTst);
    casFeatCode_position  = (null == casFeat_position) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_position).getCode();

 
    casFeat_company = jcas.getRequiredFeatureDE(casType, "company", "com.hp.hplabs.lim2.ie.text.typesystem.Annotation", featOkTst);
    casFeatCode_company  = (null == casFeat_company) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_company).getCode();

 
    casFeat_approvedBy = jcas.getRequiredFeatureDE(casType, "approvedBy", "com.hp.hplabs.lim2.ie.text.typesystem.Annotation", featOkTst);
