...
public class U2BTest {
	...
	private static final String inputFileXMIDir = "data/inputDir/news-corpora-for-ee-eval.cnews";
	private static final String U2BAggregateDesc = "desc/aggregates/u2b-test-aggregate.xml";
