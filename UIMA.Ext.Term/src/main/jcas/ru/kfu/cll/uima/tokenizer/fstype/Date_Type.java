...
public class Date_Type extends Token_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("ru.kfu.cll.uima.tokenizer.fstype.Date");
  ...
  public String getFormat(int addr) {
      ...
      jcas.throwFeatMissing("format", "ru.kfu.cll.uima.tokenizer.fstype.Date");
