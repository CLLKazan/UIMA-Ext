 ...
 * @generated */
public class Locution_Type extends Annotation_Type {
  /** @generated */
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (Locution_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = Locution_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new Locution(addr, Locution_Type.this);
  			   Locution_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new Locution(addr, Locution_Type.this);
  	  }
    };
  /** @generated */
  public final static int typeIndexID = Locution.typeIndexID;
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("ru.kfu.cll.uima.segmentation.fstype.Locution");
  ...
  public int getContentBegin(int addr) {
      ...
      jcas.throwFeatMissing("contentBegin", "ru.kfu.cll.uima.segmentation.fstype.Locution");
  ...
  public int getContentEnd(int addr) {
      ...
      jcas.throwFeatMissing("contentEnd", "ru.kfu.cll.uima.segmentation.fstype.Locution");
  ...
  /** initialize variables to correspond with Cas Type and Features
	* @generated */
  public Locution_Type(JCas jcas, Type casType) {
    super(jcas, casType);
