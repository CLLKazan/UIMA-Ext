...
public class Token_Type extends TokenBase_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("ru.kfu.cll.uima.tokenizer.fstype.Token");
  ...
  public String getTypeName(int addr) {
      ...
      jcas.throwFeatMissing("TypeName", "ru.kfu.cll.uima.tokenizer.fstype.Token");
