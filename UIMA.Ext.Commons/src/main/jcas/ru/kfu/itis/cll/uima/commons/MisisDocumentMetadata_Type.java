 ...
 * @generated */
public class MisisDocumentMetadata_Type extends Annotation_Type {
  /** @generated */
  ...
  public String getSourceUri(int addr) {
      ...
      jcas.throwFeatMissing("sourceUri", "ru.kfu.itis.cll.uima.commons.MisisDocumentMetadata");
  ...
  public long getOffsetInSource(int addr) {
      ...
      jcas.throwFeatMissing("offsetInSource", "ru.kfu.itis.cll.uima.commons.MisisDocumentMetadata");
  ...
  public long getDocumentSize(int addr) {
      ...
      jcas.throwFeatMissing("documentSize", "ru.kfu.itis.cll.uima.commons.MisisDocumentMetadata");
  ...
  public long getStartProcessingTime(int addr) {
      ...
      jcas.throwFeatMissing("startProcessingTime", "ru.kfu.itis.cll.uima.commons.MisisDocumentMetadata");
